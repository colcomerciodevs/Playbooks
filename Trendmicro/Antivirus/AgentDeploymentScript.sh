...
curl -H "Agent-Version-Control: on" -L $MANAGERURL/software/agent/${runningPlatform}${majorVersion}/${archType}/$package?tenantID=120279 -o /tmp/$package $CURLOPTIONS --insecure
...
/opt/ds_agent/dsa_control -a $ACTIVATIONURL "tenantID:9457C6A1-0F6B-9715-707B-1BA8542875D7" "token:6213E037-3CAA-6EE6-79CC-C9113721CE08" "policyid:35" "groupid:2"
# /opt/ds_agent/dsa_control -a dsm://agents.deepsecurity.trendmicro.com:443/ "tenantID:9457C6A1-0F6B-9715-707B-1BA8542875D7" "token:6213E037-3CAA-6EE6-79CC-C9113721CE08" "policyid:35" "groupid:2"